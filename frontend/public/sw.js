(() => {
  ...
  class K {
    ...
    _queueDb;
    constructor(e) {
      ((this._queueName = e), (this._queueDb = new W()));
    }
    async pushEntry(e) {
  ...
  class eu {
    _cacheableResponse;
    constructor(e) {
      this._cacheableResponse = new el(e);
    }
  ...
  class eg {
    ...
    _getCacheExpiration(e) {
      ...
      return (t || ((t = new ep(e, this._config)), this._cacheExpirations.set(e, t)), t);
    }
  ...
  class eC {
    ...
    constructor({
      ...
      if (
        ((this._concurrentPrecaching = g.concurrency),
        ...
        g.cleanupOutdatedCaches &&
          ((e) => {
            self.addEventListener('activate', (t) => {
              t.waitUntil(w(c(e)).then((e) => {}));
            });
          })(f.cacheName),
        this.registerRoute(new eS(this, p)),
        g.navigateFallback &&
          this.registerRoute(
            new en(this.createHandlerBoundToUrl(g.navigateFallback), {
              allowlist: g.navigateFallbackAllowlist,
              denylist: g.navigateFallbackDenylist,
            })
          ),
        void 0 !== l &&
          ('boolean' == typeof l ? l && eb({ serwist: this }) : eb({ ...l, serwist: this })),
        void 0 !== h)
      ) {
        if (void 0 !== d) {
  ...
  let eN = [
    ...
    eT = new eC({
      precacheEntries: [
        ...
        { revision: '92782ccb175106c8a9d3694b304005d5', url: '/DINOT\\DINOT-Light.otf' },
        { revision: '7a02e60ab46a641ee4aff1203bb133b8', url: '/DINOT\\DINOT-Medium.otf' },
        { revision: '4afbf8daaf912dae0b9a20e1fc1af809', url: '/DINOT\\DINOT-Regular.otf' },
        { revision: '56cd3bb1a6d6ab50c0057f3bdbc397af', url: '/DINOT\\DINOTBlack.pdf' },
        { revision: '4b3169463a8224fff892ff1f3a2c1e9f', url: '/DINOT\\DINOTBold.pdf' },
        { revision: '8b3f6b5edefa82ea15a3381e05d7f910', url: '/DINOT\\DINOTLight.pdf' },
        { revision: 'b9555ca3503f89bee392d49e2b7384bd', url: '/DINOT\\DINOTMedium.pdf' },
        { revision: '9923d9195c455bc9931b813194b73daa', url: '/DINOT\\DINOTRegular.pdf' },
        {
          revision: '9c4bfcc90e50a71271321750ef68c36e',
          url: '/_next/static/XUlSSmE6LMkgufIjjMM29/_buildManifest.js',
        },
        {
          revision: 'b6652df95db52feb4daf4eca35380933',
          url: '/_next/static/XUlSSmE6LMkgufIjjMM29/_ssgManifest.js',
        },
        ...
        { revision: null, url: '/_next/static/chunks/2696-dc07a838e0386dcc.js' },
        { revision: null, url: '/_next/static/chunks/3389-4a3424713ffa8b5f.js' },
        { revision: null, url: '/_next/static/chunks/3899-c12b0db6574ea29e.js' },
        { revision: null, url: '/_next/static/chunks/4111-df180043e475ecd6.js' },
        { revision: null, url: '/_next/static/chunks/448-365d7e267beeed75.js' },
        { revision: null, url: '/_next/static/chunks/4590-1f4eba81b229a9e9.js' },
        { revision: null, url: '/_next/static/chunks/4716-4006d14bc00808f2.js' },
        { revision: null, url: '/_next/static/chunks/4796-cfd7a7b026bc5645.js' },
        { revision: null, url: '/_next/static/chunks/6111-605f803ad5d95b87.js' },
        { revision: null, url: '/_next/static/chunks/6360-4f1bd581b4705d56.js' },
        { revision: null, url: '/_next/static/chunks/6516-f0fe64db4597426b.js' },
        { revision: null, url: '/_next/static/chunks/6560-2fecbc96a37760f5.js' },
        { revision: null, url: '/_next/static/chunks/6671.d3d4229631e66728.js' },
        { revision: null, url: '/_next/static/chunks/6774-6f55604b1428c766.js' },
        { revision: null, url: '/_next/static/chunks/7381-46467940ae8ce9f4.js' },
        { revision: null, url: '/_next/static/chunks/7457-d92e92f5cf3eb207.js' },
        { revision: null, url: '/_next/static/chunks/7825-23118c8554d01d73.js' },
        { revision: null, url: '/_next/static/chunks/8722.350ef1be66c840ad.js' },
        { revision: null, url: '/_next/static/chunks/8939-af6bf461f6a2806f.js' },
        ...
        {
          revision: null,
          url: '/_next/static/chunks/app/admin/(protected)/suggestions/%5Bid%5D/edit/page-cfb924046a9ca137.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/admin/(protected)/suggestions/%5Bid%5D/page-9a15617f7a904c9f.js',
        },
        ...
        {
          revision: null,
          url: '/_next/static/chunks/app/api/admin/users/route-cce2fdd2bb8e67ac.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/api/playlist_items/route-cce2fdd2bb8e67ac.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/api/playlists/%5Bid%5D/route-cce2fdd2bb8e67ac.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/api/playlists/%5Bid%5D/songs/route-cce2fdd2bb8e67ac.js',
        },
        { revision: null, url: '/_next/static/chunks/app/api/playlists/route-cce2fdd2bb8e67ac.js' },
        {
          revision: null,
          url: '/_next/static/chunks/app/api/playlists/verify/route-cce2fdd2bb8e67ac.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/api/song_links/route-cce2fdd2bb8e67ac.js',
        },
        {
          revision: null,
          url: '/_next/static/chunks/app/api/song_suggestions/route-cce2fdd2bb8e67ac.js',
        },
        { revision: null, url: '/_next/static/chunks/app/api/song_tags/route-cce2fdd2bb8e67ac.js' },
        {
          revision: null,
          url: '/_next/static/chunks/app/api/songs/%5Bid%5D/route-cce2fdd2bb8e67ac.js',
        },
        { revision: null, url: '/_next/static/chunks/app/api/songs/route-cce2fdd2bb8e67ac.js' },
        ...
        { revision: null, url: '/_next/static/chunks/app/layout-c092aedc604e3eea.js' },
        ...
        {
          revision: null,
          url: '/_next/static/chunks/app/playlists/%5Bid%5D/page-cbb2ee5f3770b48d.js',
        },
        { revision: null, url: '/_next/static/chunks/app/playlists/page-e83c8261c51208f3.js' },
        { revision: null, url: '/_next/static/chunks/app/settings/page-9a7c80e37a638cbd.js' },
        {
          revision: null,
        ...
        {
          revision: null,
          url: '/_next/static/chunks/app/songs/%5Bslug%5D/page-416db4dbebce17e1.js',
        },
        ...
        {
          revision: null,
          url: '/_next/static/chunks/next/dist/client/components/builtin/forbidden-cce2fdd2bb8e67ac.js',
        },
        {
          revision: null,
        ...
        {
          revision: null,
          url: '/_next/static/chunks/next/dist/client/components/builtin/unauthorized-cce2fdd2bb8e67ac.js',
        },
        {
          revision: '846118c33b2c0e922d7b3a7676f81f6f',
          url: '/_next/static/chunks/polyfills-42372ed130431b0a.js',
        },
        { revision: null, url: '/_next/static/chunks/webpack-7ed0469bdeabbe14.js' },
        { revision: null, url: '/_next/static/css/8dfd8bfd35dcb5aa.css' },
        {
        ...
        { revision: 'e53fccb352f02d62fd00e136889bfb72', url: '/campfire\\only_fire.svg' },
        {
        ...
        { revision: '536f45d86a9be726f8bfdeda7aa9b826', url: '/campfire\\wood2.png' },
        { revision: '3d8676055196fd33f875c99228d23114', url: '/favicon\\apple-touch-icon.png' },
        { revision: '2268fa771cc1176d8c75cc7ec2cd0f3f', url: '/favicon\\favicon-96x96.png' },
        { revision: '8e3f6bc20d147978c40c53684d48cd03', url: '/favicon\\favicon.ico' },
        { revision: '1499fb85a2c6cb743a73d6a4213c549c', url: '/favicon\\favicon.svg' },
        { revision: 'b6cb9b56a48ef77f8c083527d03e4c7c', url: '/favicon\\site.webmanifest' },
        {
        ...
        { revision: '8d65b0abf33ef8aff96d5b90dff671db', url: '/google_logo.png' },
      ...
      runtimeCaching: [
        {
          matcher: ({ request: e }) => 'navigate' === e.mode || 'document' === e.destination,
          handler: new ee({
            cacheName: 'pages',
            networkTimeoutSeconds: 3,
            plugins: [new eu({ statuses: [0, 200] })],
          }),
        },
        {
          matcher: ({ url: e }) => e.pathname.startsWith('/_next/static/'),
          handler: new eq({
            cacheName: 'next-static',
            plugins: [
              new eu({ statuses: [0, 200] }),
              new eg({ maxEntries: 500, maxAgeSeconds: 2592e3 }),
            ],
          }),
        },
        ...eN,
      ...
      fallbacks: {
        entries: [{ url: '/offline', matcher: ({ request: e }) => 'navigate' === e.mode }],
      },
    });
  (self.addEventListener('fetch', (e) => {
    let t = new URL(e.request.url),
      a = '1' === e.request.headers.get('RSC') || t.searchParams.has('_rsc');
    ((t.pathname.startsWith('/songs/') && '/songs/' !== t.pathname) ||
      (t.pathname.startsWith('/playlists/') && '/playlists/' !== t.pathname)) &&
      e.respondWith(
        (async () => {
          try {
            let s = await fetch(e.request);
            if (s.ok) {
              let r = await caches.open(a ? 'dynamic-rsc' : 'dynamic-pages');
              a ? r.put(t.pathname, s.clone()) : r.put(e.request, s.clone());
            }
            return s;
          } catch (n) {
            let s,
              r = await caches.open(a ? 'dynamic-rsc' : 'dynamic-pages');
            if (a) s = await r.match(t.pathname);
            else if (!(s = await r.match(e.request))) {
              let e = t.pathname.startsWith('/songs/') ? '/songs/' : '/playlists/',
                a = (await r.keys()).find((t) => new URL(t.url).pathname.startsWith(e));
              a && (s = await r.match(a));
            }
            if (s) return s;

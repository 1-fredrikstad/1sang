...
// Slightly modified switch from shadcn to implement sun and moon icons for themetoggle
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          'group-data-[size=lg]/switch:size-5 group-data-[size=lg]/switch:data-checked:translate-x-[calc(100%-2px)]'
        )}
      >
        {thumbContent}
      </SwitchPrimitive.Thumb>

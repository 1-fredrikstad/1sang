...
export function SuggestionsCollapsible({ suggestions }: SuggestionsCollapsibleProps) {
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      ...
      <CollapsibleContent className="allow-animation min-h-10 collapsible-content data-[state=open]:animate-slideDown data-[state=closed]:animate-slideUp px-0 pb-4 mt-2 pt-1">

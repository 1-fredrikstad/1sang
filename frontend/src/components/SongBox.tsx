...
export function SongBox({ song }: SongBoxProps) {
  ...
  return (
    <li className="relative rounded-sm outline-1 dark:bg-list-bg outline-[#0000001a] dark:shadow-xs dark:shadow-black hover:shadow-sm active:scale-[0.99] transition">
